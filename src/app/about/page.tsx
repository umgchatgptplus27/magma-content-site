      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                이 사이트의 가이드는 공개 자료를 조사해 정리하는 정보 콘텐츠입니다. 글과 이미지 제작에 AI 도구를 활용합니다. 별도로 확인 방법과 결과를 제시하지 않은 글을 직접 착용 후기나 제품 시험 보고서로 보아서는 안 됩니다.
              </p>
              <p>
                스타일을 설명하는 예시 이미지는 특정 상품의 실제 사진이나 소재 성능·세탁 효과의 증거가 아닙니다. 실제 제품을 선택하거나 관리할 때는 해당 제품의 치수표와 케어라벨을 확인해 주세요.
              </p>
              <p>
                자료에서 확인한 사실과 편집상 제안은 구분합니다. 직접 측정하거나 사용한 사례를 소개할 때에는 대상과 조건, 관찰 결과와 한계를 함께 밝히겠습니다.
              </p>
            </>
          ),
        },
