  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          title: "콘텐츠 제작 방식과 이미지의 범위",
          content: (
            <>
              <p>
                이 사이트의 가이드는 철저한 자료 조사와 자체적인 편집 기준을 거쳐 작성되는 정보 콘텐츠입니다. MAGMA 편집부의 꼼꼼한 검수를 통해 독자에게 유익하고 정확한 정보를 전달하는 것을 최우선으로 합니다. 별도로 확인 방법과 결과를 제시하지 않은 글을 특정 환경의 직접 착용 후기나 제품 시험 보고서로 보아서는 안 됩니다.
              </p>
              <p>
                스타일을 설명하는 예시 이미지는 이해를 돕기 위한 참고 자료이며, 특정 상품의 실제 사진이나 소재 성능·세탁 효과의 증거가 아닙니다. 실제 제품을 선택하거나 관리할 때는 해당 제품의 치수표와 케어라벨을 확인해 주세요.
              </p>
              <p>
                자료에서 확인한 사실과 편집상 제안은 철저히 구분합니다. 전문가적 견해가 필요한 부분은 공식 기관이나 신뢰할 수 있는 출처를 최우선으로 인용하며, 관찰 결과와 그 한계를 투명하게 밝히겠습니다.
              </p>
            </>
          ),
        },
